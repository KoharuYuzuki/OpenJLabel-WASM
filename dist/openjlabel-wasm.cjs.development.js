...
var openjlabel = /*#__PURE__*/function () {
  var _scriptDir = (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('openjlabel-wasm.cjs.development.js', document.baseURI).href));
  return /*#__PURE__*/function () {
    var _ref = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(moduleArg) {
      var Module, readyPromiseResolve, readyPromiseReject, moduleOverrides, arguments_, thisProgram, quit_, ENVIRONMENT_IS_WEB, ENVIRONMENT_IS_WORKER, ENVIRONMENT_IS_NODE, scriptDirectory, locateFile, read_, readAsync, readBinary, _yield$import, createRequire, require$1, fs, nodePath, out, err, wasmBinary, wasmMemory, ABORT, EXITSTATUS, assert, HEAP8, HEAPU8, HEAP16, HEAP32, HEAPU32, updateMemoryViews, __ATPRERUN__, __ATINIT__, __ATMAIN__, __ATPOSTRUN__, preRun, initRuntime, preMain, postRun, addOnPreRun, addOnInit, addOnPostRun, runDependencies, runDependencyWatcher, dependenciesFulfilled, getUniqueRunDependency, addRunDependency, removeRunDependency, abort, dataURIPrefix, isDataURI, isFileURI, wasmBinaryFile, getBinarySync, getBinaryPromise, instantiateArrayBuffer, instantiateAsync, createWasm, tempDouble, tempI64, ExitStatus, callRuntimeCallbacks, noExitRuntime, ExceptionInfo, exceptionLast, ___cxa_throw, setErrNo, PATH, initRandomFill, _randomFill, PATH_FS, UTF8Decoder, UTF8ArrayToString, FS_stdin_getChar_buffer, lengthBytesUTF8, stringToUTF8Array, intArrayFromString, FS_stdin_getChar, TTY, mmapAlloc, MEMFS, asyncLoad, FS_createDataFile, preloadPlugins, FS_handledByPreloadPlugin, FS_createPreloadedFile, FS_modeStringToFlags, FS_getMode, FS, UTF8ToString, SYSCALLS, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_ioctl, ___syscall_newfstatat, ___syscall_openat, ___syscall_stat64, _abort, _emscripten_memcpy_js, getHeapMax, growMemory, _emscripten_resize_heap, ENV, getExecutableName, getEnvStrings, stringToAscii, _environ_get, _environ_sizes_get, runtimeKeepaliveCounter, keepRuntimeAlive, _proc_exit, exitJS, _exit, _fd_close, doReadv, _fd_read, convertI32PairToI53Checked, _fd_seek, doWritev, _fd_write, isLeapYear, arraySum, MONTH_DAYS_LEAP, MONTH_DAYS_REGULAR, addDays, writeArrayToMemory, _strftime, _strftime_l, handleException, stringToUTF8, stringToUTF8OnStack, FSNode, readMode, writeMode, wasmImports, wasmExports, _main, _errno_location, _stackAlloc, _cxa_is_pointer_type, calledRun, callMain, run, shouldRunNow;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            run = function _run(args) {
              if (args === void 0) {
                args = arguments_;
              }
            ...
            callMain = function _callMain(args) {
              if (args === void 0) {
                args = [];
              }
            ...
            ExceptionInfo = function _ExceptionInfo(excPtr) {
              this.excPtr = excPtr;
              this.ptr = excPtr - 24;
          ...
          case 48:
            ...
            require$1 = createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('openjlabel-wasm.cjs.development.js', document.baseURI).href)));
            fs = require$1("fs");
            nodePath = require$1("path");
            if (ENVIRONMENT_IS_WORKER) {
              scriptDirectory = nodePath.dirname(scriptDirectory) + "/";
            } else {
              scriptDirectory = require$1("url").fileURLToPath(new URL("./", (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('openjlabel-wasm.cjs.development.js', document.baseURI).href))));
            }
            ...
            readAsync = function readAsync(filename, onload, onerror, binary) {
              if (binary === void 0) {
                binary = true;
              }
              filename = isFileURI(filename) ? new URL(filename) : nodePath.normalize(filename);
          ...
          case 64:
            ...
            if (Module["locateFile"]) {
              ...
              wasmBinaryFile = new URL("openjlabel.wasm", (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('openjlabel-wasm.cjs.development.js', document.baseURI).href))).href;
            }
            ...
            exceptionLast = 0;
            ___cxa_throw = function ___cxa_throw(ptr, type, destructor) {
              var info = new ExceptionInfo(ptr);
              info.init(type, destructor);
              exceptionLast = ptr;
              throw exceptionLast;
            };
            setErrNo = function setErrNo(value) {
            ...
            FS = {
              ...
              createStream: function createStream(stream, fd) {
                if (fd === void 0) {
                  fd = -1;
                }
                if (!FS.FSStream) {
            ...
            _emscripten_memcpy_js = function _emscripten_memcpy_js(dest, src, num) {
            ...
            getEnvStrings = function getEnvStrings() {
            ...
            arraySum = function arraySum(array, index) {
              var sum = 0;
            ...
            _strftime = function _strftime(s, maxsize, format, tm) {
            ...
            _strftime_l = function _strftime_l(s, maxsize, format, tm, loc) {
            ...
            _main = Module["_main"] = function (a0, a1) {
              return (_main = Module["_main"] = wasmExports["u"])(a0, a1);
            };
            _errno_location = function ___errno_location() {
              return (_errno_location = wasmExports["w"])();
            };
            _stackAlloc = function stackAlloc(a0) {
              return (_stackAlloc = wasmExports["x"])(a0);
            };
            _cxa_is_pointer_type = function ___cxa_is_pointer_type(a0) {
              return (_cxa_is_pointer_type = wasmExports["y"])(a0);
            };
...
exports.default = openjlabel;
//# sourceMappingURL=openjlabel-wasm.cjs.development.js.map
