...
var openjlabel = (() => {
  ...
  return async function(moduleArg = {}) {
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      var require$1 = createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('index.cjs', document.baseURI).href)));
      var fs = require$1("fs");
    ...
    if (Module["locateFile"]) {
      ...
      wasmBinaryFile = new URL("openjlabel.wasm", (typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.src || new URL('index.cjs', document.baseURI).href))).href;
    }
...
const _openjlabel = openjlabel;

module.exports = _openjlabel;
